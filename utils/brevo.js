...
const brevo = async (userEmail, userName,html) => {
    ...
    const data = {
        htmlContent: `<html><head></head><body><p>Hello ${userName} ,</p>Welcome to Eunicon Furnitures!.</p></body></html>`,
        sender: {
            email: "iyanu9491@gmail.com",
            name: "From Eunicon Furnitures",
        },
        subject: "Hello from Eunicon Furnitures!",
    };
    sendSmtpEmail.to = [{
        email: userEmail
    }] 
