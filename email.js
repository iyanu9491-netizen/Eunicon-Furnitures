...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Reset Your Eunicon Furnitures Password</title>
    <style>
        /* Mobile Styles */
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="container" style="width: 100%; max-width: 500px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                        ...
                        <tr>
                            <td align="center" style="padding: 30px 20px; background-color: #ffffff; border-bottom: 1px solid #eeeeee;">
                                <h1 style="margin: 0; color: rgba(8, 155, 252, 0.92); font-size: 24px; font-weight: 800; letter-spacing: 1px;">ENUICON FURNITURES</h1>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="content" style="padding: 40px; text-align: center; color: #333333;">
                                ...
                                <p style="font-size: 14px; color: #999999; margin-top: 25px; line-height: 1.4;">
                                    This code is valid for <strong>30 seconds</strong>. <br>
                        ...
                        <tr>
                            <td align="center" style="padding: 25px; background-color: #fafafa; font-size: 12px; color: #aaaaaa;">
                                <p style="margin: 0;">&copy; 2026 Eunicon Furnitures. All rights reserved.</p>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="container" style="width: 100%; max-width: 500px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.08);">
                        ...
                        <tr>
                            <td class="content" style="padding: 40px; text-align: center; color: #333333;">
                                ...
                                <!-- CTA Button -->
                                <a href="https://euniconfurnitures.com" class="cta-button" style="display: inline-block; background-color: #00d2ff; color: #ffffff; padding: 16px 35px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px;">
                                    Log In to EUNICON FURNITURES
                                </a>
